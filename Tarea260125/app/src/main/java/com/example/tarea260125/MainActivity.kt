...
import com.example.tarea260125.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun loginGoogle() {
        val googleConf = GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
            //REVISAR ESTA PARTE
            .requestIdToken(getString(R.string.google_client_id)) // Asegúrate de usar este ID
            .requestEmail()
            .build()
        val googleClient = GoogleSignIn.getClient(this, googleConf)

        googleClient.signOut() // Evitar login automático si cierra sesión previamente
